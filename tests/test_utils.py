...
def test_list_exported_names():
    ...
    x = list_exported_names("example._styles")
...
def test_split_module_name_asname():
    ...
    x = split_module_name("example._styles.ExampleClassGoogle")
    assert x == ("ExampleClassGoogle", "example._styles")
